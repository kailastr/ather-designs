    ...
    const ssLightbox = function () {
        ...
        const videoLightbox = function () {
            ...
            videoLink.addEventListener('click', function (event) {
                ...
                const videoId = new URL(vLink).searchParams.get('v'); // Extract the video ID from the URL
                const embedLink = "https://www.youtube.com/embed/" + videoId; // Create the embed URL

                const iframe = "<iframe width='560' height='315' src='" + embedLink + "' frameborder='0' allow='accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture' allowfullscreen></iframe>";
